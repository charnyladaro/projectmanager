...
function addProjectToDOM(projectId, name, description) {
  ...
  projectListItem.setAttribute("data-project-id", projectId);
...
function displayProject(projectId) {
  ...
  // Fetch project details using projectId (you can use fetch API or AJAX here)
  const project = projects.find((proj) => proj.id === projectId);

  // Display project details in the current-project section
  ...
  addTaskBtn.addEventListener("click", () => openModal("task-form-modal"));

  // Pre-fill project ID in the task form modal
